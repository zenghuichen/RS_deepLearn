...
from config.config import unet_model_config_RGB123,unet_model_config_RGB124,unet_model_config_RGB134,unet_model_config_RGB234
...
def test(model,testloader,running_metrics,epoch,lossfunction,logobject,muilt=True,global_step=0,image_step=100,writer=None,datasetname=""):
    '''
    测试数据集
    '''
...
if __name__=="__main__":
    ...
    plt.ion()
    config_param=unet_model_config_RGB123 # RGB123
    mainTrain(config_param,isTest=True)
    config_param=unet_model_config_RGB124 # RGB124
    mainTrain(config_param,isTest=True)
    config_param=unet_model_config_RGB134 # RGB134
    mainTrain(config_param,isTest=True)
    config_param=unet_model_config_RGB234 # RGB234
    mainTrain(config_param,isTest=True)
    plt.close()
