...
if __name__=="__main__":
    ...
    plt.ion()
    config_param=segnet_model_config_RGB123 # RGB123
    mainTrain(config_param,isTest=True)
    config_param=segnet_model_config_RGB124 # RGB124
    mainTrain(config_param,isTest=True)
    config_param=segnet_model_config_RGB134 # RGB134
    mainTrain(config_param,isTest=True)
    config_param=segnet_model_config_RGB234 # RGB234
    mainTrain(config_param,isTest=True)
    plt.close()
